...
class SecondFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        router = mrouter
        view.findViewById<Button>(R.id.second_to_third).setOnClickListener {
            router.navigateTo(Screens.ThirdFragment)
        }
        view.findViewById<Button>(R.id.second_to_first).setOnClickListener {
